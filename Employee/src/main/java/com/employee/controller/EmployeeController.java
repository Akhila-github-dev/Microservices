...
public class EmployeeController {
	...
	public Response getEmployeeParm(@RequestParam("id") Long id) throws EmployeeNotFoundException {
		return getEmployeeFrom(id);

	}

	private Response getEmployeeFrom(Long id) throws EmployeeNotFoundException {
